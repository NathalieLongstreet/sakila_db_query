# specify database to be affected
USE sakila;
...
# 3a 3a. You want to keep a description of each actor
SELECT * FROM actor;
ALTER TABLE actor ADD COLUMN description BLOB;

# 3b- 3b. Very quickly you realize that entering descriptions for each actor is too much effort. Delete the description column
ALTER TABLE actor
